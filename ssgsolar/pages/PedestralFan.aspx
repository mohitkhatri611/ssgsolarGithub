<%@ Page Title="" Language="C#" MasterPageFile="~/pages/ProductMaster.Master" AutoEventWireup="true" CodeBehind="PedestralFan.aspx.cs" Inherits="ssgsolar.pages.PedestralFan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="description">
       ...
       <p>12V Solar DC Pedestal Fan - 20W - Three Speed Oscillating - RPM - 1450 - 16 Inch Sweep   Fan comes with DC-DC Cable with open wire interface (instead of a plug), connect to any 12V DC source like 12V Solar Panel, 12V Battery, 12V Solar Charge Controller, or 12V DC Distribution Board - Please don't connect or plug into 24V/48V DC or higher DC Voltage or 220V AC Electricity mains</p>
        ...
        <ul>
            <li>Jerk free and smooth oscillation; Sweep: 400mm</li>
            <li>An elegant high speed fan with modern looks</li>
            <li>Unique pivot arrangement for tilting and oscillation</li>
            <li>Aerodynamically designed PP blades</li>
            <li>Provision for height adjustment, light weight and portable for easy movement</li>
