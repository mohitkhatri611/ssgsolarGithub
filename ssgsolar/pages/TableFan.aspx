<%@ Page Title="" Language="C#" MasterPageFile="~/pages/ProductMaster.Master" AutoEventWireup="true" CodeBehind="TableFan.aspx.cs" Inherits="ssgsolar.pages.TableFan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="description">
       ...
       <p>This fan is manufactured using top-notch quality components and sophisticated techniques by adroit professionals. Ideal to be used for converting solar energy into high speed cool air, this fan is widely installed in various industries, restaurants and hospitals. Our precious clients can buy this Solar Powered Fan from us at pocket friendly rates.</p>
        ...
        <p>An ideal & an affordable solution that works on DC supply. Large fan blade diameter ensures higher air flow and swing feature covers a larger area.</p>
        ...
        <ul>
            ...
            <li>14 inch diameter wide non-rust plastic fan with 3 Blade.</li>
            <li>Total wattage (W): 18 W</li>
            <li>12V DC Operated</li>
            <li>Easily Up Down Rotatable</li>
            <li>Total Length : 17.5 inch</li>
        ...
        <ul>
            <li>Type: Solar Fan</li>
            <li>Fan Color: blue with white</li>
            <li>Voltage: 12V DC</li>
            <li>Motor Type: High Speed Copper Motor</li>
            <li>1Size: 16"</li>
